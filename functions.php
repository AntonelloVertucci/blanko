...
//include_once('includes/swiper/swiper.php');
include_once('includes/jobs/jobs.php');
...
/*
    ...
    =============================================
*/
function AV_social_media_icons_func(){
    return avia_social_media_icons( array( 'class' => '__social--media--icons' ), false );
}
add_shortcode('social_media_icons', 'AV_social_media_icons_func');